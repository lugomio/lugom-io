window.onload = () => {
    const navHTML = `
        <style>
            ...
            #fixedNavLugom label:hover {
                border-color: #fff
            }
            
            #fixedNavLugom label>img {
                height: 100%;
                width: auto;
                border-radius: 1rem
            }
            
            #fixedNavLugom label nav img {
                width: 24px;
                height: auto;
                margin-bottom: -3px
            }
            
            #fixedNavLugom label nav ul {
                list-style: none;
                display: flex;
                flex-direction: row;
                gap: .8rem;
            ...
            #fixedNavLugom label nav ul li a {
                display: block;
                opacity: 0;
                padding: 8px;
                border-radius: 8px;
            ...
            #fixedNavLugom label nav ul li a:hover {
                background-color: #332a00
            }
            
            #fixedNavLugom label nav ul li:nth-child(1) a {
                animation: animationFixedNav .4s ease .4s forwards
            }
            
            #fixedNavLugom label nav ul li:nth-child(2) a {
                animation: animationFixedNav .4s ease .3s forwards
            }
            
            #fixedNavLugom label nav ul li:nth-child(3) a {
                animation: animationFixedNav .4s ease .2s forwards
            }
            
            #fixedNavLugom label nav ul li:nth-child(4) a {
                animation: animationFixedNav .4s ease .1s forwards
            }
            
            #fixedNavLugom #fixedNavLugomCheckbox:checked+label {
                width: 64px
            }
            
            #fixedNavLugom #fixedNavLugomCheckbox,
            #fixedNavLugom #fixedNavLugomCheckbox:checked+label nav {
                display: none
            }
        </style>
